...
$addqueryResults = Invoke-AzOperationalInsightsQuery -WorkspaceId $workspaceId -Query $addqr
$rmqueryResults = Invoke-AzOperationalInsightsQuery -WorkspaceId $workspaceId -Query $rmqr
